  ...
  return (
    <Grid container spacing={4} columns={12}>
      ...
      <Grid size={{ xs: 12, lg: 9 }}>
        ...
        <br />
        <Typography component="h7" variant="body1" sx={{ mb: 2 }}>
          <b>
            {" "}
            Образователна и научна степен "доктор" се придобива след успешно
            защитен научен труд - дисертация.
          </b>
          <br />
          Подготовката става чрез обучение в докторантура, под научното
          ръководство на водещи специалисти в научната област.
          <br />
          Дисертационният труд се защитава пред Научно жури, състоящо се от
          известни учени и трябва да съдържа съществени научно-приложни и
          приложни приноси.
          <br /> В зависимост от научната област по време на докторантурата
          докторантът извършва специфичната изследователска работа, заложена в
          неговия индивидуален план, подготвя се теоретично в областите,
          включени в същия план, явява се на докторантски изпити и разработва
        ...
        <List sx={{ listStyleType: "disc" }}>
          ...
          <ListItem sx={{ display: "list-item" }}>
            различни мобилности по международни и/или национални програми и
            проекти като провеждат научно-изследователска работа или обучение в
            чужди или наши университети или научно­изследователски центрове, в
            съответствие с докторската програма, по която се обучават и др.
          </ListItem>
        </List>
