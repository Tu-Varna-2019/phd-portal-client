import { lostLeadsReportFn } from "Services/Report"
...
const LostLeadsReport = () => {
  const [page, setPage] = useState(1)
  const [search, setSearch] = useState("")

  const { data, isLoading } = useQuery(["lostLeadsReport", page, search], () => lostLeadsReportFn({ page, search }))
